...
uses
  ...
  System.IOUtils, FMX.Controls.Presentation, FMX.Effects, FMX.Filter.Effects,
  FMX.Ani;
...
type
  TMainForm = class(TForm)
    ...
    OinkEffect: TRotateCrumpleTransitionEffect;
    OinkAnimation: TFloatAnimation;
...
begin
  ...
  begin
    OinkAnimation.Start;
    MediaPlayer.FileName := System.IOUtils.TPath.GetDocumentsPath + PathDelim +
      'oink.mp3';
    MediaPlayer.Play;
  end;
end;
