...
uses
  ...
  FMX.ListBox, FMX.Memo.Types, FMX.ScrollBox, FMX.Controls.Presentation;
...
begin
  ...
  TetheringAppProfile.Resources.FindByName('MessageText').Value :=
    MessageTextMemo.Text;
  TetheringAppProfile.Resources.FindByName('MessageBackgroundColor').Value :=
    MessageColorComboBox.Color;
end;
